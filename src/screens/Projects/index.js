...
import Winetique from "./Winetique";
const Projects = () => {
			...
			<div className="project-container">
				<div className="girl-container">
					...
					{firelyIsVisible && (
						<img
							src={FirelyGirl}
							style={{ width: "560px", height: "560px", marginTop: "80px" }}
							alt="girl.png"
						/>
					)}
					{winetiqueIsVisible && (
					...
					{babycareIsVisible && (
						<img
							src={BabycareG}
							style={{ width: "560px", height: "560px", marginTop: "60px" }}
							alt="girl.png"
						/>
					)}
					{/* {!winetiqueIsVisible && !firelyIsVisible && (
						<img
							src={WinetiqueG}
